        ...
        if (preg_match('/^[0-9]*$/', $pouleid))
        {
            if ($pouleid >= 1 && $pouleid <= 100)
            {
                ...
                if ($result > 0)
                {
                    ...
                    header("Location: ../public/add-matches.php?succes=$succes&pouleid=$pouleid");
...
//                    }
                    ...
                    {
                        header("Location: ../public/add-matches.php?message=$nothingFound");
                    }
            }else
                {
                    header("Location: ../public/add-matches.php?message=$inputError");
                }
        }else
            {
                header("Location: ../public/add-matches.php?message=$inputError");
        ...
        {
            header("Location: ../public/add-matches.php?message=$empty");
        }
}else
    {
        echo "hndjednf";
