...
namespace ProjectFifaV2
{
    public partial class frmLogin : Form
    {
        ...
        {
            //checks if either the username or password textarea is empty
            ...
            else
            {
                ...
                //gives back message if a user already exsists
                if (exist)
                {
                ...
                {
                    //inputs the value's given from txtUsername and txtPassword 
        ...
        private void btnLogin_Click(object sender, EventArgs e)
        {
            ...
            bool exist = false;
            //takes the login detail from the textboxses into string varibles
            string username = txtUsername.Text;
            string password = txtPassword.Text;
            //resets the login textboxes
            txtUsername.Text = "";
            txtPassword.Text = "";
